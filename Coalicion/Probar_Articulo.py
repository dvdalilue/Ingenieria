...
class Test_Articulo(unittest.TestCase):
    ...
    def setUp(self):
        self.art = Articulo(1,"Titulo1", ["Pedro Perez"], ["Palabra" ,"clave"],
                             ["bases de datos"], "texto", "resumen")
        self.art2 = Articulo(2,"Titulo2", ["Jose Perez"], ["Pal" ,"cla"],
                              ["bases datos"], "texto", "resumen")
        self.m1 = MiembroCp(3,"Coronel", "Mostaza", "USB", "ma@usb.ve" 
                            ,"Venezuela")
        self.m2 = MiembroCp(4,"Blanco", "Rojo", "USB", "br@usb.ve" 
                            ,"Venezuela")
        self.m3 = MiembroCp(5,"Verdi", "Camejo", "USB", "vc@usb.ve"
                             ,"Venezuela")
        self.m4 = MiembroCp(6,"Coronel", "Mostaza", "USB", "ma@usb.ve"
                             ,"Venezuela")
        self.m5 = MiembroCp(7,"Blanco", "Rojo", "USB", "br@usb.ve" 
                            ,"Venezuela")
        self.m6 = MiembroCp(8,"Verdi", "Camejo", "USB", "vc@usb.ve" 
                            ,"Venezuela")
    ...
    # colocando la primera evaluacion del articulo
        ...
        self.assertEqual(self.art.calificaciones, [1]), 
        "falla colocando la primera puntuacion"
        self.assertEqual(self.art.jurado[0], self.m1) , 
        "falla colocando al primer jurado"
    ...
    def test_calificar_articulo2(self):
        ...
        self.assertEqual(self.art.calificaciones, [1,4]),
        "falla colocando la segunda puntuacion"
        self.assertEqual(self.art.jurado[1], self.m2),
        "falla colocando al segundo jurado"
    ...
    def test_calificar_articulo3(self):
        ...
        self.assertEqual(self.art.calificaciones, []),
        "falla colocando la tercera puntuacion"
    ...
    def test_calificar_articulo4(self):
        ...
        self.assertEqual(self.art.calificaciones, [3] ),
        "falla colocando  puntuacion de un juez que ya voto"
    ...
    def test_promedio(self):
        ...
        self.assertEqual(self.art.calificaciones, [1,4,5]),
        "falla colocando la tercera puntuacion"
    ...
    def test_verificar_Aceptable_ATrue(self):
        ...
        self.assertTrue(self.art.verificar_aceptable()),
        "Falla verificando un articulo aceptable"
    ...
    def test_verificar_Aceptable_BFalse(self):
        ...
        self.art.calcular_promedio()
        self.assertFalse(self.art.verificar_aceptable()), 
        "Falla verificando articulo no aceptable"
 
    def test_verificar_Aceptable_falta_jurado(self):
        self.art2.calificar(self.m1, 3)
        self.assertFalse(self.art2.verificar_aceptable()), 
        "Falla verificando articulo con un solo jurado"
        
        self.art2.calificar(self.m2, 4)
        self.assertFalse(self.art2.verificar_aceptable()) , 
        "Falla verificando articulo con dos jurados"

        self.art2.calificar(self.m3, 3)
        self.assertTrue(self.art2.verificar_aceptable()) , 
        "Falla verifcando articulo con tres jurados"
